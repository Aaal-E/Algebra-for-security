...
\substaction{Euclid’s Extended Algorithm}


\section{Modular arithmetic}

\substaction{Modular reduction}

\substaction{Addition, subtraction}
\substaction{Multiplication}

\substraction{Modular inversion for a large modulus m}
